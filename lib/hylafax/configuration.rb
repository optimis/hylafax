module Hylafax
  class Configuration
    attr_accessor :sendfax_path, :sendfax_host, :faxstat_path, :faxstat_delimiter, :faxrm_path, :faxrm_admin_password, :speed, :cover_sheet
    ...
    def initialize(*args)
      if args[0].is_a?(Hash)
        ...
        faxstat_delimiter     = args[0]['faxstat_delimiter']
      ...
      @faxstat_delimiter      = faxstat_delimiter     || ENV['FAX_FAXSTAT_DELIMITER']
